...
<body>
  ...
  <form action='addedcity.php' method='POST'> 
    <div class='mb-3'>
    ...
    <div class='mb-3'>
      <label for='imglink' class='form-label'>IMG_LINK</label>
      <input type='text' class='form-control' id='imglink' aria-describedby='emailHelp' name='imglink'>
    </div>
